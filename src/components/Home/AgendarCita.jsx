import Dentista from "../../assets/dentista-1.png";
import Silla from "../../assets/silla-1.png";
import Diente from "../../assets/diente-feliz-1.png";
      ...
      <div className="agenda w-full  relative md:mt-32 md:h-64 ">
        <div className="container-agenda flex flex-col gap-5  p-8  rounded-md md:grid md:grid-cols-3 md:max-w-6xl md:m-auto relative  ">
          ...
          >
            ...
            <h3 className="text-base font-semibold text-change">
              Agenda tu cita
            </h3>
