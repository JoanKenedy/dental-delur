        ...
        <div className="container-info w-[85%] m-auto grid gap-4 md:grid-cols-2 md:max-w-6xl">
          <div className="item-info">
            <img
              src={Foto}
              alt=""
              className="w-full md:w-[470px] rounded-lg shadow-lg shadow-slate-400 "
            />
          </div>
          <div className="item-info flex flex-col justify-center items-center gap-1">
            <h3 className="text-2xl text-change font-semibold md:text-2xl">
              Envíanos un mensaje
            </h3>
            ...
            <a
              ...
              target="_blank"
              className="bg-header-change border rounded-2xl flex items-center justify-center gap-1 px-3 py-3 my-2 md:hover:scale-95 duration-300"
            >
